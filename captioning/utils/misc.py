...
def build_optimizer(params, opt):
    ...
    # if opt.optim == 'rmsprop':
    #     return optim.RMSprop(filter(lambda p: p.requires_grad, params), opt.learning_rate, opt.optim_alpha, opt.optim_epsilon, weight_decay=opt.weight_decay)
    # elif opt.optim == 'adagrad':
    #     return optim.Adagrad(filter(lambda p: p.requires_grad, params), opt.learning_rate, weight_decay=opt.weight_decay)
    # elif opt.optim == 'sgd':
    #     return optim.SGD(filter(lambda p: p.requires_grad, params), opt.learning_rate, weight_decay=opt.weight_decay)
    # elif opt.optim == 'sgdm':
    #     return optim.SGD(filter(lambda p: p.requires_grad, params), opt.learning_rate, opt.optim_alpha, weight_decay=opt.weight_decay)
    # elif opt.optim == 'sgdmom':
    #     return optim.SGD(filter(lambda p: p.requires_grad, params), opt.learning_rate, opt.optim_alpha, weight_decay=opt.weight_decay, nesterov=True)
    # elif opt.optim == 'adam':
    ...
    # elif opt.optim == 'adamw':
    #     return optim.AdamW(filter(lambda p: p.requires_grad, params), opt.learning_rate, (opt.optim_alpha, opt.optim_beta), opt.optim_epsilon, weight_decay=opt.weight_decay)
    # else:
    #     raise Exception("bad option opt.optim: {}".format(opt.optim))
