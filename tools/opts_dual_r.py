...
def if_use_feat(caption_model):
    ...
    elif caption_model in ['updown', 'topdown', 'adaatt', 'updownon', 'onatt', 'm2on']:
...
def parse_opt():
    ...
    parser.add_argument('--rel_iou_threshold',type=float, default=0.1)
    parser.add_argument('--bboxes_embed_size',type=int, default=1024)
    parser.add_argument('--class_embed_size',type=int, default=300)
    parser.add_argument('--training_method',type=str, default='xe')
    parser.add_argument('--input_object_dir', type=str, default='data/cocotalk_box')
    parser.add_argument('--input_attr_dir', type=str, default='data/cocotalk_box')
    parser.add_argument('--drop_prob_position', type=float, default=0.5)
    parser.add_argument('--drop_prob_semantic', type=float, default=0.5)
    parser.add_argument('--semantic_relation_size', type=int, default=628)
    parser.add_argument('--semantic_relation_layers', type=int, default=1)
    parser.add_argument('--use_enhanced_feats', type=int, default=0)
    parser.add_argument('--w2v_path', type=str, default="./data/objects_vestors.json")
    parser.add_argument('--hierarchy_attention', type=int, default=1, help='attention type')
    parser.add_argument('--relation_loss_weight', type=float, default=0.5, help='relation weight')
    parser.add_argument('--padding_region_length', type=int, default=40, help='images region padding length')
    parser.add_argument('--gt_relation_path', type=str, default="./data/relationships_500_500_200.h5", help='surpervision relaiton data')
    parser.add_argument('--meteor_reward_weight', type=float, default=0.0, help='mentor reward weight')
    parser.add_argument('--ablation_study', type=str, default="111", help='mentor reward weight')
    parser.add_argument('--paratalk_vocab_path', type=str, default="./data/paratalk.json", help='vocab path')
    parser.add_argument('--CC', type=float, default=2, help='CC for abaltion study')
    parser.add_argument('--print_for_visual', type=int, default=0, help='C for abaltion study')

    parser.add_argument('--seed',type=int, default=SEED)
    parser.add_argument('--coco_caption_path_train', type=str, default='./data/annotations/para_captions_train.json')
    parser.add_argument('--coco_caption_path_val', type=str, default='./data/annotations/para_captions_val.json')
    parser.add_argument('--coco_caption_path_test', type=str, default='./data/annotations/para_captions_test.json')

    parser.add_argument('--train_visual_features_path', type=str, default='./densecap_fea/im2p_train_output.h5')
    parser.add_argument('--test_visual_features_path', type=str, default='./densecap_fea/im2p_test_output.h5')
    parser.add_argument('--val_visual_features_path', type=str, default='./densecap_fea/im2p_val_output.h5')
    
    parser.add_argument('--clip_fc_features_path', type=str, default='./clip_fea/clip_fc_feats_last.h5')
    parser.add_argument('--clip_region_features_path', type=str, default='./clip_fea/clip_region_feats_last.h5')
    
    parser.add_argument('--encoded_paragraphs_path', type=str, default='')
    parser.add_argument('--train_mapping_file_path', type=str, default='./densecap_fea/imgs_train_path.txt')
    parser.add_argument('--test_mapping_file_path', type=str, default='./densecap_fea/imgs_test_path.txt')
    parser.add_argument('--val_mapping_file_path', type=str, default='./densecap_fea/imgs_val_path.txt')
    parser.add_argument('--vocab_path', type=str, default='')
    parser.add_argument('--return_box_info', type=bool, default=False)
    ...
    # Model settings
    parser.add_argument('--num_box', type=int, default=50)
    ...
    parser.add_argument('--chunk_size', type=int, default=8,
                    help='number of units per chunk defined in ON-LSTM paper')
    parser.add_argument('--dropconnect', type=float, default=0.,
                    help='drop connection technique for ON-LSTM')
...
def add_eval_options(parser):
    ...
    parser.add_argument('--eval_tree', type=int, default=0,
                    help='if we need to calculate tree edit distance.')
